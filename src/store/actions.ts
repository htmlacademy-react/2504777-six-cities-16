...
export const loadFullOffer = createAction('loadFullOffer', (value: null | FullOffer) => ({payload:value}));
export const loadOffersNearby = createAction('loadOffersNearby', (value: Offers) => ({payload:value}));
